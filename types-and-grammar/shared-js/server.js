...
routes.push(
  ...
  function FooRoute(req, res) {
    if (
      ...
      // if Foo.random() returned a promise, the lines following would
      // be inside a .then()
      var num = Foo.random();
...
// an * prefix means this is a generator in ES6
// It does not run all by itself, needs something to drive it.
